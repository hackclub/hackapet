...
#===MAIN MENU===#
main_menu_background_bmp = displayio.OnDiskBitmap("main_menu_background.bmp")
main_menu_bmp = displayio.OnDiskBitmap("main_menu.bmp")
main_menu_decor_bmp = displayio.OnDiskBitmap("main_menu_decor.bmp")
...
loading_screen_bmp = displayio.OnDiskBitmap("loading_screen.bmp")
...
while(play_dino_game):
    ...
    score_labels_bmp = displayio.OnDiskBitmap("score_labels.bmp")
    main_game_background_bmp = displayio.OnDiskBitmap("main_game_background.bmp")
    obis_bmp = displayio.OnDiskBitmap("obis.bmp")
    player_bmp = displayio.OnDiskBitmap("player.bmp")
    ...
    you_died_bmp = displayio.OnDiskBitmap("dead.bmp")
    main_menu_background = displayio.TileGrid(main_menu_background_bmp, pixel_shader=main_menu_background_bmp.pixel_shader)
